...
def user(request, username):
    ...
    if user== request.user:
        return HttpResponseRedirect(reverse('App_Login:profile'))
    return render(request, 'App_Login/user_other.html', context={'user_other':user_other, 'title':'User Profile Page ','already_followed':already_followed})
...
def unfollow(request, username):
    ...
    already_unfollowed=Follow.objects.get(follower=unfollower_user, following=unfollowing_user)
    
    already_unfollowed.delete()
